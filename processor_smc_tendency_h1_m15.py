...
# -*- coding: utf-8 -*-
"""
SMC_TENDENCY_H1_M15 - Procesador Backend

Este procesador:
1. Lee velas desde public.market_candles
2. Ejecuta análisis SMC con validación: Dirección índice + H1 + Evento M15
...
if __name__ == "__main__":
    print("="*70)
    print(" SMC_TENDENCY_H1_M15 - Procesador Backend")
    print("="*70)
    print(f"⚠️  TABLA DESTINO: {TARGET_TABLE}")
    print(f"⚠️  NO escribe en: smc_m15_setups ni smc_h1_m15_setups")
